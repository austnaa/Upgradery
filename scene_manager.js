class SceneManager {
    ...
    loadLevel() {
        ...
        // this.game.addEntity(new Block(this.game, 0, PARAMS.BLOCKWIDTH * 3));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH, PARAMS.BLOCKWIDTH * 3));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 2, PARAMS.BLOCKWIDTH * 3));

        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 3, PARAMS.BLOCKWIDTH * 4));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 4, PARAMS.BLOCKWIDTH * 4));

        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 5, PARAMS.BLOCKWIDTH * 3));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 6, PARAMS.BLOCKWIDTH * 3));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 7, PARAMS.BLOCKWIDTH * 3));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 8, PARAMS.BLOCKWIDTH * 3));
        
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 5, 0));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 6, 0));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 7, 0));
        // this.game.addEntity(new Block(this.game, PARAMS.BLOCKWIDTH * 8, 0));
